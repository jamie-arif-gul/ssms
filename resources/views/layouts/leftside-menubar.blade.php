...
<ul class="nav flex-column">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" style="width: 100%;">
      <!-- Dropdown menu links -->
      <li>
        <a class="dropdown-item" href="{{ url('fees/category') }}"><i class="material-icons">developer_board</i> <span class="nav-link-text">@lang('Fee Category')</span></a>
      </li>
      <li>
        <a class="dropdown-item" href="{{ url('fees/plan') }}"><i class="material-icons">developer_board</i> <span class="nav-link-text">@lang('Fee Plan')</span></a>
      </li>
      <li>
